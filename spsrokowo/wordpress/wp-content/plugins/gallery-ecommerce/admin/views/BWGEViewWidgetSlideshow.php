...
class BWGEViewWidgetSlideshow {
  ...
  function widget($args, $instance) {
    ...
    // Widget output.
  require_once(WD_BWGE_DIR . '/frontend/controllers/BWGEControllerSlideshow.php');
    $controller_class = 'BWGEControllerSlideshow';
  ...
  function form($instance, $id_title, $name_title, $id_gallery_id, $name_gallery_id, $id_width, $name_width, $id_height, $name_height, $id_filmstrip_height, $name_filmstrip_height, $id_effect, $name_effect, $id_interval, $name_interval, $id_shuffle, $name_shuffle, $id_theme_id, $name_theme_id) {
    ...
    <p <?php echo ($options_row->slideshow_enable_filmstrip ? '' : 'style="display: none;"'); ?>>
      <label for="<?php echo $id_filmstrip_height; ?>"><?php echo __('Filmstrip height:', 'bwge_back'); ?></label>
    ...
    <p>
      <label for="<?php echo $id_effect; ?>"><?php echo __('Slideshow effect:', 'bwge_back'); ?></label>
    ...
    <p>
      <label for="<?php echo $id_interval; ?>"><?php echo __('Time interval:', 'bwge_back'); ?></label>
    ...
    <p>
      ...
      <input type="radio" name="<?php echo $name_shuffle; ?>" id="<?php echo $id_shuffle . "_1"; ?>" value="1" <?php if ($instance['shuffle']) echo 'checked="checked"'; ?> onclick='jQuery(this).nextAll(".bwge_hidden").first().attr("value", "1");' /><label for="<?php echo $id_shuffle . "_1"; ?>"><?php echo __('Yes', 'bwge_back'); ?></label>
      <input type="radio" name="<?php echo $name_shuffle; ?>" id="<?php echo $id_shuffle . "_0"; ?>" value="0" <?php if (!$instance['shuffle']) echo 'checked="checked"'; ?> onclick='jQuery(this).nextAll(".bwge_hidden").first().attr("value", "0");' /><label for="<?php echo $id_shuffle . "_0"; ?>"><?php echo __('No', 'bwge_back'); ?></label>
      <input type="hidden" name="<?php echo $name_shuffle; ?>" id="<?php echo $id_shuffle; ?>" value="<?php echo $instance['shuffle']; ?>" class="bwge_hidden" />
    </p>
    <p>
