...
class BWGEControllerWidgetTags extends WP_Widget {
  ////////////////////////////////////////////////////////////////////////////////////////
  // Events                                                                             //
  ////////////////////////////////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////////////////////////
  ...
  public function __construct() {
    ...
    require_once WD_BWGE_DIR . "/admin/models/BWGEModelWidgetTags.php";
    $this->model = new BWGEModelWidgetTags();

    require_once WD_BWGE_DIR . "/admin/views/BWGEViewWidgetTags.php";
    $this->view = new BWGEViewWidgetTags($this->model);
  }
  ////////////////////////////////////////////////////////////////////////////////////////
  // Public Methods                                                                     //
  ////////////////////////////////////////////////////////////////////////////////////////
