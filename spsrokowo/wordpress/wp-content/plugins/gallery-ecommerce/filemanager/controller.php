...
class BWGEFilemanagerController {
    ...
    public function rename_item() {
      ...
      $_REQUEST['file_names'] = '';
      $query_url = wp_nonce_url( admin_url('admin-ajax.php'), 'bwge_addImages', 'bwge_nonce' );
      $query_url = add_query_arg(array('action' => 'bwge_bwge_addImages', 'filemanager_msg' => $msg, 'width' => '650', 'height' => '500', 'task' => 'display', 'extensions' => esc_html($_REQUEST['extensions']), 'callback' => esc_html($_REQUEST['callback']), 'dir' => esc_html($_REQUEST['dir']), 'TB_iframe' => '1'), $query_url);
      header('Location: ' . $query_url);
      exit;
    }
