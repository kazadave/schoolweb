...
class BWGEFilemanagerModel {
    ...
    private function bwge_wp_read_image_metadata( $file ) {
      ...
      if ( is_callable( 'exif_read_data' ) && in_array( $sourceImageType, apply_filters( 'wp_read_image_metadata_types', array( IMAGEbwge_typeJPEG, IMAGEbwge_typeTIFF_II, IMAGEbwge_typeTIFF_MM ) ) ) ) {
