 ...
 *
 *  0.0 - Compatibility.
 *    0.1 - Back-compatibility. Tiny Framework only works in WordPress 4.1 or later.
...
if ( version_compare( $GLOBALS['wp_version'], '4.1-alpha', '<' ) ) {
	require get_template_directory() . '/inc/back-compat-wp-4-1.php';
}
...
function tinyframework_display_credits() {
	$text = sprintf( esc_html__( 'Using %s', 'tiny-framework' ), '<a href="http://mtomas.com/1/tiny-forge-free-mobile-first-wordpress-theme">Tiny Framework</a> ' );
	...
	$text .= sprintf( esc_html__( ' and %s', 'tiny-framework' ), '<a href="http://mtomas.com/1/tiny-forge-free-mobile-first-wordpress-theme">Tiny Framework</a> ' );
	*/
...
// 12.5 - Add again default attachement image class attributes. See: https://core.trac.wordpress.org/ticket/36996#comment:3
