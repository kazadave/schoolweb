...
function tinyframework_entry_meta_top() {
	...
	if ( 'post' === get_post_type() ) {
		printf( '<span class="byline"><span class="author vcard" itemprop="author" itemscope="" itemtype="https://schema.org/Person"><span class="screen-reader-text">%1$s </span><a class="url fn n" href="%2$s" rel="author" itemprop="url name">%3$s</a></span></span>',
...
function tinyframework_comment( $comment, $args, $depth ) {
	...
	<li id="li-comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
		<article id="comment-<?php comment_ID(); ?>" class="comment-body" itemprop="comment" itemscope itemtype="https://schema.org/Comment">
			<header class="comment-meta">
				<?php
					echo get_avatar( $comment, 56 );
					printf( '<cite><span class="comment-author p-author author vcard hcard h-card" itemprop="creator" itemscope itemtype="http://schema.org/Person"><b class="fn p-name" itemprop="name">%1$s</b></span> %2$s</cite>',
