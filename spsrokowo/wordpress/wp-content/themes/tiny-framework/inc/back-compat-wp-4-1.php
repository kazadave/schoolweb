 ...
 *
 * This function deactivates our newly activated theme if WP isn't newer than 4.1.
...
function tinyframework_upgrade_notice() {
	$message = sprintf( __( 'Tiny Framework requires at least WordPress version 4.1. You are running version %s. Please upgrade and try again.', 'tiny-framework' ), $GLOBALS['wp_version'] );
...
function tinyframework_customize() {
	wp_die( sprintf( __( 'Tiny Framework requires at least WordPress version 4.1. You are running version %s. Please upgrade and try again.', 'tiny-framework' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function tinyframework_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Tiny Framework requires at least WordPress version 4.1. You are running version %s. Please upgrade and try again.', 'tiny-framework' ), $GLOBALS['wp_version'] ) );
	}
}
