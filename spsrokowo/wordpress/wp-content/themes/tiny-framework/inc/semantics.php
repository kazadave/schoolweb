 ...
 * -- rel="author"
 * -- rel="designer" (in functions.php only)
 *
 ...
 * --- u-photo (in inc/semantics.php only)
 *
		...
		case 'body':
			if ( ! is_singular() ) {
				...
				if ( is_front_page() ) {
					...
					// Is specific category. E.g. category for our blog.  See other conditional options: https://developer.wordpress.org/reference/functions/is_category/
