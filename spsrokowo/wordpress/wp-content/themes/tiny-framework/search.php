...
get_header(); ?>
	...
	<section id="primary" class="content-area">
		...
		<main id="main" class="site-main" role="main" itemprop="mainContentOfPage" itemscope="itemscope" itemtype="https://schema.org/SearchResultsPage">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="page-header">
				...
				<h1 class="page-title" itemprop="headline"><?php printf( esc_html__( 'Search Results for: %s', 'tiny-framework' ), get_search_query() ); ?></h1>
